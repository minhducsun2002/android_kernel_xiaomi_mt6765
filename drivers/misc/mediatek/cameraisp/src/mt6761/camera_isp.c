...
/*      */
static volatile struct ISP_RT_BUF_STRUCT *pstRTBuf;
...
static signed int ISP_DumpReg(void)
{
	...
	/*Print in CMD_STATUS */
	/* mdp crop     */
	cmdq_err("MDPCROP Related");
	cmdq_err("0x%08X %08X", (unsigned int)(ISP_ADDR + 0xd10),
		(unsigned int)ISP_RD32(ISP_ADDR + 0xd10));
	cmdq_err("0x%08X %08X", (unsigned int)(ISP_ADDR + 0xd20),
		(unsigned int)ISP_RD32(ISP_ADDR + 0xd20));
	/* cq */
	cmdq_err("CQ Related");
	ISP_WR32(ISP_IMGSYS_BASE + 0x4160, 0x6000);
	cmdq_err("0x%08X %08X (0x15004160=6000)",
		(unsigned int)(ISP_IMGSYS_BASE + 0x4164),
		(unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4164));
	ISP_WR32(ISP_IMGSYS_BASE + 0x4160, 0x7000);
	cmdq_err("0x%08X %08X (0x15004160=7000)",
		(unsigned int)(ISP_IMGSYS_BASE + 0x4164),
		(unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4164));
	ISP_WR32(ISP_IMGSYS_BASE + 0x4160, 0x8000);
	cmdq_err("0x%08X %08X (0x15004160=8000)",
		(unsigned int)(ISP_IMGSYS_BASE + 0x4164),
		(unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4164));

	/* update pixel count after eol */
	/* update line count after eot */
	/* check imgi line counts & pixel counts */
	ISP_WR32(ISP_IMGSYS_BASE + 0x4160,
		((unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4160)&0xFFFF0FFF));
	ISP_WR32(ISP_IMGSYS_BASE + 0x75f4, 0x21e);
	cmdq_err("[YUV]IMGI_debug_0=0x%08X	%08X (0x150075f4=021e)",
		(unsigned int)(ISP_IMGSYS_BASE + 0x4164),
		(unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4164));
	/* check img2o line counts & pixel counts */
	ISP_WR32(ISP_IMGSYS_BASE + 0x4160,
		((unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4160)&0xFFFF0FFF));
	ISP_WR32(ISP_IMGSYS_BASE + 0x75f4, 0x1e1e);
	cmdq_err("[YUV]IMG2O_debug_0=0x%08X	%08X (0x150075f4=01e1e)",
		(unsigned int)(ISP_IMGSYS_BASE + 0x4164),
		(unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4164));
	/* check img3o line counts & pixel counts */
	ISP_WR32(ISP_IMGSYS_BASE + 0x4160,
		((unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4160)&0xFFFF0FFF));
	ISP_WR32(ISP_IMGSYS_BASE + 0x75f4, 0x1a1e);
	cmdq_err("[YUV]IMG3O_debug_0=0x%08X	%08X (0x150075f4=01a1e)",
		(unsigned int)(ISP_IMGSYS_BASE + 0x4164),
		(unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4164));

	/* update pixel count after valid reg */
	/* update line count after eol */
	/* check imgi line counts & pixel counts */
	ISP_WR32(ISP_IMGSYS_BASE + 0x4160,
		((unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4160)&0xFFFF0FFF));
	ISP_WR32(ISP_IMGSYS_BASE + 0x75f4, 0x11e);
	cmdq_err("[YUV]IMGI_debug_0=0x%08X	%08X (0x150075f4=011e)",
		(unsigned int)(ISP_IMGSYS_BASE + 0x4164),
		(unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4164));
	/* check img2o line counts & pixel counts */
	ISP_WR32(ISP_IMGSYS_BASE + 0x4160,
	...
	cmdq_err("[YUV]IMG2O_debug_0=0x%08X	%08X (0x150075f4=01d1e)",
		(unsigned int)(ISP_IMGSYS_BASE + 0x4164),
		(unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4164));
	/* check img3o line counts & pixel counts */
	ISP_WR32(ISP_IMGSYS_BASE + 0x4160,
		((unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4160)&0xFFFF0FFF));
	ISP_WR32(ISP_IMGSYS_BASE + 0x75f4, 0x191e);
	cmdq_err("[YUV]IMG3O_debug_0=0x%08X	%08X (0x150075f4=0191e)",
		(unsigned int)(ISP_IMGSYS_BASE + 0x4164),
		(unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4164));
	/* imgi_debug */
	...
	log_err("0x%08X %08X (0x150075f4=031e)",
		...
		(unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4164));
	/* yuv */
	cmdq_err("yuv-mdp crop Related");
	ISP_WR32(ISP_IMGSYS_BASE + 0x4160, 0x3014);
	cmdq_err("0x%08X %08X (0x15004160=3014)",
		(unsigned int)(ISP_IMGSYS_BASE + 0x4164),
		(unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4164));
	cmdq_err("yuv-lce_out Related");
	ISP_WR32(ISP_IMGSYS_BASE + 0x4160, 0x3016);
	cmdq_err("0x%08X %08X (0x15004160=3016)",
		(unsigned int)(ISP_IMGSYS_BASE + 0x4164),
		(unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4164));
	ISP_WR32(ISP_IMGSYS_BASE + 0x4160, 0x3017);
	cmdq_err("0x%08X %08X (0x15004160=3017)",
		(unsigned int)(ISP_IMGSYS_BASE + 0x4164),
		(unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4164));
	ISP_WR32(ISP_IMGSYS_BASE + 0x4160, 0x3018);
	cmdq_err("0x%08X %08X (0x15004160=3018)",
		(unsigned int)(ISP_IMGSYS_BASE + 0x4164),
		(unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4164));
	ISP_WR32(ISP_IMGSYS_BASE + 0x4160, 0x3019);
	cmdq_err("0x%08X %08X (0x15004160=3019)",
		(unsigned int)(ISP_IMGSYS_BASE + 0x4164),
		(unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4164));
	cmdq_err("yuv-crsp_out Related");
	ISP_WR32(ISP_IMGSYS_BASE + 0x4160, 0x301a);
	cmdq_err("0x%08X %08X (0x15004160=301a)",
		(unsigned int)(ISP_IMGSYS_BASE + 0x4164),
		(unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4164));
	ISP_WR32(ISP_IMGSYS_BASE + 0x4160, 0x301b);
	cmdq_err("0x%08X	%08X (0x15004160=301b)",
		(unsigned int)(ISP_IMGSYS_BASE + 0x4164),
		(unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4164));
	ISP_WR32(ISP_IMGSYS_BASE + 0x4160, 0x301c);
	cmdq_err("0x%08X	%08X (0x15004160=301c)",
		(unsigned int)(ISP_IMGSYS_BASE + 0x4164),
		(unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4164));
	ISP_WR32(ISP_IMGSYS_BASE + 0x4160, 0x301d);
	cmdq_err("0x%08X	%08X (0x15004160=301d)",
		(unsigned int)(ISP_IMGSYS_BASE + 0x4164),
		(unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4164));
	cmdq_err("yuv-c24b out Related");
	ISP_WR32(ISP_IMGSYS_BASE + 0x4160, 0x301e);
	cmdq_err("0x%08X %08X (0x15004160=301e)",
		(unsigned int)(ISP_IMGSYS_BASE + 0x4164),
		(unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4164));
	ISP_WR32(ISP_IMGSYS_BASE + 0x4160, 0x301f);
	cmdq_err("0x%08X %08X (0x15004160=301f)",
		(unsigned int)(ISP_IMGSYS_BASE + 0x4164),
		(unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4164));
	ISP_WR32(ISP_IMGSYS_BASE + 0x4160, 0x3020);
	cmdq_err("0x%08X %08X (0x15004160=3020)",
		(unsigned int)(ISP_IMGSYS_BASE + 0x4164),
		(unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4164));
	ISP_WR32(ISP_IMGSYS_BASE + 0x4160, 0x3021);
	cmdq_err("0x%08X %08X (0x15004160=3021)",
		(unsigned int)(ISP_IMGSYS_BASE + 0x4164),
		(unsigned int)ISP_RD32(ISP_IMGSYS_BASE + 0x4164));
	/*ANR1_LceLink */
	...
	for (i = 0x0; i <= 0x200; i += 0x8) {
		cmdq_err("[0x%08X %08X],[0x%08X %08X]",
			(unsigned int)(ISP_TPIPE_ADDR + i),
			(unsigned int)ISP_RD32(ISP_ADDR + i),
			(unsigned int)(ISP_TPIPE_ADDR + i + 0x4),
			(unsigned int)ISP_RD32(ISP_ADDR + i + 0x4));
	}
	for (i = 0xd00; i <= 0xd20; i += 0x8) {
		cmdq_err("[0x%08X %08X],[0x%08X %08X]",
			(unsigned int)(ISP_TPIPE_ADDR + i),
			(unsigned int)ISP_RD32(ISP_ADDR + i),
			(unsigned int)(ISP_TPIPE_ADDR + i + 0x4),
